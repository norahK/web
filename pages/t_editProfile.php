 ...
 $Lname=$_SESSION['lname'];
   ...
   $selectd=mysql_query("SELECT * FROM ".$_SESSION['op']." WHERE ID =".$id);
    ...
    if(isset($_POST['update'])){
        ...
        $email=$_POST['email'];
        $pass=$_POST['pass'];
      $update="UPDATE ".$_SESSION['op']." SET FName='$fname', LName='$lname', Email='$email', Password='$pass' WHERE ID='$id'";
      ...
      <div class="col-md-9 personal-info">
        <form class="form-horizontal" role="form" method="post" >
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <input class="form-control" name="fname" type="text" value="<?php echo $Fname; ?>" pattern="^[A-Za-z]+" required>
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label">Last name:</label>
            <div class="col-lg-8">
              <input class="form-control" name="lname" type="text" value="<?php echo $Lname; ?>" pattern="^[A-Za-z]+" required>
            </div>
          </div>
          <div class="form-group">
